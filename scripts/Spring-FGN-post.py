...
def main(N=3, dt=1.0e-3, useN=5, withdata=None, datapoints=100, mpass=1, grid=False, stride=100, ifdrag=0, seed=42, rname=0, saveovito=1, trainm=1, runs=70, semilog=1, maxtraj=100, plotthings=False, redo=0):
    ...
    np.savetxt("../spring-generalizibility/3-fgn.txt", gmean_zerr, delimiter = "\n")
    # np.savetxt("../spring-herr/fgn.txt", gmean_herr, delimiter = "\n")
    # np.savetxt("../spring-perr/fgn.txt", gmean_perr, delimiter = "\n")
    # np.savetxt("../spring-simulation-time/fgn.txt", [t/maxtraj], delimiter = "\n")
