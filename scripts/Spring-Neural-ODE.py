...
def main(N=5, epochs=10000, seed=42, rname=False, saveat=10,
    ...
    np.savetxt("../Spring-training-time/gnode1.txt", train_time_arr, delimiter = "\n")
    np.savetxt("../Spring-training-loss/gnode1-train.txt", larray, delimiter = "\n")
    np.savetxt("../Spring-training-loss/gnode1-test.txt", ltarray, delimiter = "\n")
