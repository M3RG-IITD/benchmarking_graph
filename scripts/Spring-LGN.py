...
def main(N=3, epochs=10000, seed=42, rname=True, saveat=10, error_fn="L2error",
    ...
    for epoch in range(epochs):
        ...
        if epoch % saveat == 0:
            ...
            np.savetxt("../Spring-training-time/lgn.txt", train_time_arr, delimiter = "\n")
            np.savetxt("../Spring-training-loss/lgn-train.txt", larray, delimiter = "\n")
            np.savetxt("../Spring-training-loss/lgn-test.txt", ltarray, delimiter = "\n")
