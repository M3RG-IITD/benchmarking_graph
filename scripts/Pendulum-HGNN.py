...
def main(N = 2, epochs = 10000, seed = 42, rname = False,
    ...
    np.savetxt("../training-time/hgnn.txt", train_time_arr, delimiter = "\n")
    np.savetxt("../training-loss/hgnn-train.txt", larray, delimiter = "\n")
    np.savetxt("../training-loss/hgnn-test.txt", ltarray, delimiter = "\n")
