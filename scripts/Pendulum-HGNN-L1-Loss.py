...
def main(N = 2, epochs = 10000, seed = 42, rname = False,
    ...
    for epoch in range(epochs):
        ...
        if epoch % 1 == 0:
            ...
            print(
                f"Epoch: {epoch}/{epochs} Loss (MME):  train={larray[-1]}, test={ltarray[-1]}")
        ...
        if epoch % 10 == 0:
            ...
            np.savetxt("../training-time/hgnn-l1.txt", train_time_arr, delimiter = "\n")
            np.savetxt("../training-loss/hgnn-l1-train.txt", larray, delimiter = "\n")
            np.savetxt("../training-loss/hgnn-l1-test.txt", ltarray, delimiter = "\n")
