...
def get_forward_sim(params=None, zdot_func=None, runs=10):
    def fn(R, V):
        ...
        return ode.odeint(zdot_func, z0(R, V), t, params)
    return fn


sim_orig = get_forward_sim(params=None, zdot_func=zdot_func, runs=maxtraj*runs)
# z_out = sim_orig(R, V)
