...
def main(N=2, epochs=10000, seed=42, rname=False,  error_fn="L2error", mpass=1, saveat=10,
    ...
    np.savetxt("../training-time/gnode2.txt", train_time_arr, delimiter = "\n")
    np.savetxt("../training-loss/gnode2-train.txt", larray, delimiter = "\n")
    np.savetxt("../training-loss/gnode2-test.txt", ltarray, delimiter = "\n")
