...
def main(N=5, epochs=10000, seed=42, rname=False, saveat=10,
    ...
    np.savetxt("../Spring-training-time/ddgnn.txt", train_time_arr, delimiter = "\n")
    np.savetxt("../Spring-training-loss/ddgnn-train.txt", larray, delimiter = "\n")
    np.savetxt("../Spring-training-loss/ddgnn-test.txt", ltarray, delimiter = "\n")
