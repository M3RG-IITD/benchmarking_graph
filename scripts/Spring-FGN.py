...
def main(N=3, epochs=10000, seed=42, rname=True, saveat=10, error_fn="L2error",
    ...
    np.savetxt("../Spring-training-time/fgn.txt", train_time_arr, delimiter = "\n")
    np.savetxt("../Spring-training-loss/fgn-train.txt", larray, delimiter = "\n")
    np.savetxt("../Spring-training-loss/fgn-test.txt", ltarray, delimiter = "\n")
